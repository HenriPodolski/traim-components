import { r as registerInstance, h, H as Host } from './index-bc9dc136.js';
...
const TraimTooltip = class {
    ...
    render() {
        ...
        return (h(Host, { onClick: () => this.show() }, h("div", { class: `tooltip ${appearanceClass} ${orientationClass} ${hoverClass} ${visibleClass}` }, h("slot", { name: "tooltip-trigger" }), h("div", { class: "tooltip__display" }, h("slot", { name: "tooltip-display" })))));
    }
};
