...
var TraimAutocomplete = /** @class */ (function () {
    ...
    class_2.prototype.selectedItemChangedHandler = function (newValue) {
...
var traimSliderSlideCss = ":host{display:block}.slider-slide{display:none;-ms-flex-pack:center;justify-content:center;-ms-flex-align:center;align-items:center;min-height:40px}.slider-slide.is-active{display:-ms-flexbox;display:flex}";
