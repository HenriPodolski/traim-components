...
const TraimTimelineItem = class {
    ...
    render() {
        ...
        return (index.h("li", { class: `timeline-item ${typeClass} ${leftClass} ${lastClass} ${loadingClass}` }, index.h("div", { class: "timeline-item__body" }, index.h("slot", null))));
    }
};
