...
const TraimToggle = class {
    ...
    render() {
        return (index.h("label", { class: "toggle", onClick: (e) => this.handleToggle(e) }, index.h("input", { type: "checkbox", "aria-checked": this._toggled.toString(), checked: this._toggled }), index.h("div", { class: "toggle__track" }, index.h("div", { class: "toggle__handle" })), index.h("slot", null)));
    }
