...
const TraimAccordion = class {
    constructor(hostRef) {
        ...
        this.onToggle = core.createEvent(this, "toggle", 7);
    }
    onTogglePane(ev) {
    ...
    render() {
        ...
        return (core.h("div", { class: `accordion ${useCounterClass}` }, core.h("slot", null)));
    }
...
const TraimAccordionPane = class {
    constructor(hostRef) {
        ...
        this.open = false;
        this.empty = false;
        this.onToggle = core.createEvent(this, "togglepane", 7);
    }
    componentWillLoad() {
    ...
    render() {
        ...
        return [
            core.h("button", { role: "heading", "aria-expanded": this._isOpen.toString(), tabindex: !this.empty ? 0 : -1, class: `control ${isOpenClass} ${isEmptyClass}`, onClick: () => !this.empty && this.toggle(), innerHTML: this.header }),
            core.h("section", { "aria-hidden": !this._isOpen, class: `pane` }, core.h("slot", null)),
        ];
    }
...
const TraimAutocomplete = class {
    constructor(hostRef) {
        ...
        this.onSelect = core.createEvent(this, "selectAutocomplete", 7);
        this.onSearch = core.createEvent(this, "searchAutocomplete", 7);
    }
    ...
    render() {
        return (core.h("div", { class: "autocomplete" }, core.h("input", { id: this.uid, name: this.uid, type: "search", class: "autocomplete__input", placeholder: this.placeholder, autocomplete: "off", value: this.value, onInput: (e) => this.search(e), onFocus: () => this.open(), onClick: () => this.open() }), (this._isOpen) && (core.h("div", { role: "menu", class: "autocomplete__list" }, this.items.map((item) => {
            const isActiveClass = this.activeItem === item ? 'is-active' : '';
            return (core.h("button", { role: "menuitem", class: `autocomplete__list-item ${isActiveClass}`, onClick: () => this.select(item) }, item.value.title));
        }), this.emptyMessage && this.items.length === 0 && (core.h("div", { role: "menuitem", "aria-disabled": true, class: "autocomplete__empty" }, this.emptyMessage))))));
    }
...
const TraimSlider = class {
    ...
    render() {
        ...
        return (core.h(core.Host, null, core.h("div", { class: `slider ${animationClass}` }, core.h("section", { ref: (el) => this.slidesWrapperElement = el, class: `slider__slides` }, core.h("slot", null)), this.countSlides > 1 && this.controls && (core.h("button", { onClick: () => this.gotoSlide(this.activeSlideIndex - 1), role: "button", class: `slider__button is-left`, "aria-label": this.controlLeftText }, core.h("span", { "aria-hidden": "true", class: `slider__button-inner` }, "\u276E"))), this.countSlides > 1 && this.controls && (core.h("button", { onClick: () => this.gotoSlide(this.activeSlideIndex + 1), role: "button", class: `slider__button is-right`, "aria-label": this.controlRightText }, core.h("span", { "aria-hidden": "true", class: `slider__button-inner` }, "\u276F"))))));
    }
    static get watchers() { return {
...
const TraimSliderSlide = class {
    ...
    render() {
        ...
        return (core.h(core.Host, null, core.h("div", { class: `slider-slide ${activeClass}` }, core.h("slot", null))));
    }
    static get style() { return ":host{display:block}.slider-slide{display:none;-ms-flex-pack:center;justify-content:center;-ms-flex-align:center;align-items:center;min-height:40px}.slider-slide.is-active{display:-ms-flexbox;display:flex}"; }
};

exports.traim_accordion = TraimAccordion;
exports.traim_accordion_pane = TraimAccordionPane;
exports.traim_autocomplete = TraimAutocomplete;
exports.traim_slider = TraimSlider;
exports.traim_slider_slide = TraimSliderSlide;
