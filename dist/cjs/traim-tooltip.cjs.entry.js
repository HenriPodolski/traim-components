...
const TraimTooltip = class {
    ...
    render() {
        ...
        return (core.h(core.Host, { onClick: () => this.show() }, core.h("div", { class: `tooltip ${appearanceClass} ${orientationClass} ${hoverClass} ${visibleClass}` }, core.h("slot", { name: "tooltip-trigger" }), core.h("div", { class: "tooltip__display" }, core.h("slot", { name: "tooltip-display" })))));
    }
