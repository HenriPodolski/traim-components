...
const TraimTabs = class {
    ...
    render() {
        return (core.h("div", { class: "tabs" }, core.h("div", { role: "tablist", class: "tabs__tablist" }, core.h("div", { class: "tabs__nav" }, core.h("div", { class: "tabs__headings" }, this.tabs.map((tab, i) => {
            const openClass = tab.open ? 'is-active' : '';
            return (core.h("button", { role: "tab", disabled: tab.disabled, class: `tabs__heading ${openClass}`, onClick: () => this.openTab(i) }, tab.header));
        }))), core.h("slot", null))));
    }
